...
<head>
    ...
    <link rel="stylesheet" href="<c:url value='/views/admin/admin/style.css'/>">
...
<body class="nav-md">
                    ...
                    <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                        <div class="menu_section">
                            <ul class="nav side-menu">
                                <li><a href="trangchu.html"><i class="fa fa-home"></i> Trang Chủ Admin </span></a></li>
                                ...
                                <li><a><i class="fa fa-shopping-cart"></i> Quản Trị Sản Phẩm <span
                                            class="fa fa-chevron-down"></span></a>
                                    <ul class="nav child_menu">
            ...
            <div class="right_col" role="main">
                <div class="page-title">
                    <div class="title-left">
                        <a href="trangchu.html" style="font-size: 15px;">Trang chủ Admin </a>
                        <span class=" fa fa-chevron-right"></span>
                        <a href="#" style="font-size: 15px;"> Quản Trị Sản Phẩm </a>
                        <span class=" fa fa-chevron-right"></span>
                        <a href="product.html" style="font-size: 15px;"> Sản Phẩm</a>
                        <span class=" fa fa-chevron-right"></span>
                        <a href="product-add.html" style="font-size: 15px;"> Thêm</a>
                    </div>
                </div>
                <div class="clearfix"></div>
                        ...
                        <div class="panel">
                            ...
                            <div class="x-content">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9 col-sm-9">
                                        <input type="text" class="textbox-sp">
                                    </div>
                                </div>
                                <hr>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9 col-sm-9">
                                        <textarea name=""cols="30" rows="5" placeholder="Nhập dòng mô tả ngắn sản phẩm/bài viết tại khung này" class="textbox-sp"></textarea>
                                    </div>
                                </div>
                                <hr>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9 col-sm-9">
                                        <textarea name="myTextarea" id="myTextarea" cols="30" rows="5" placeholder="Nhập nội dung thông tin sản phẩm chi tiết tại khung này" class="textbox-sp"></textarea>
                                    </div>
                                </div>
                                <div class="form-group" style="margin-top: 30px;">
                                    ...
                                    <div class="col-md-9 col-sm-9">
                                        <input type="submit" value="Lưu" class="btn-addproduct">
  ...
  <script src="<c:url value='/views/admin/vendors/flot.curvedlines/curvedLines.js'/>"></script>
    ...
    <!-- JQVMap -->
    <script src="<c:url value='/views/admin/vendors/jqvmap/dist/jquery.vmap.js'/>"></script>
    <script src="<c:url value='/views/admin/vendors/jqvmap/dist/maps/jquery.vmap.world.js'/>"></script>
    <script src="<c:url value='/views/admin/vendors/jqvmap/examples/js/jquery.vmap.sampledata.js'/>"></script>
   <!-- bootstrap-daterangepicker -->
